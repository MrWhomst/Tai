...
enum MainChartHelper {
    ...
    enum Config {
        ...
        /// Full history span available by panning; backfilled lazily.
        static let maxChartHistorySeconds: TimeInterval = 72 * 3600
        /// Backfill triggers when the visible leading edge gets this close
        /// to the domain start.
        static let historyBackfillLeadSeconds: TimeInterval = 2 * 3600
